    ...
    public class ReflectPainter : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (cam == null && Input.GetMouseButtonDown(0))
            {
                ...
                if (Physics.Raycast(ray, out hitInfo))
                {
                    ...
                    if (paintObject != null)
                    {
                        ...
                        var camObj = Instantiate(camPref, hitInfo.point, Quaternion.LookRotation(hitInfo.normal),
                            hitInfo.transform) as GameObject;
            ...
            else if (cam != null)
            {
                ...
                Effective.GrabArea.Clip(brush.BrushTexture, brush.Scale, rt, Vector3.one * 0.5f, brush.RotateAngle,
                    Effective.GrabArea.GrabTextureWrapMode.Clip, buf);
